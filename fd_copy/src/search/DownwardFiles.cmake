...
fast_downward_plugin(
    NAME TP_ITERATED_SEARCH
    HELP "TP iterated search algorithm"
    SOURCES
        search_engines/tp_iterated_search.cc
    DEPENDS SEARCH_COMMON
)

fast_downward_plugin(
    NAME TP_LAZY_SEARCH
    HELP "TP lazy search algorithm"
    SOURCES
        search_engines/tp_lazy_search.cc
    DEPENDS SEARCH_COMMON
)
